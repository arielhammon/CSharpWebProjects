...
namespace InsuranceQuoteDB.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterAndCustomerVM model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.regVM.Email, Email = model.regVM.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    using (var db = new InsuranceQuoteDBEntities())
                    {
                        ...
                        var custUser = new CustomerAspNetUser { CustomerID = customer.Id, AspNetUserID = user.Id };
